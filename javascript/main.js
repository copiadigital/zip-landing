...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.Pristine = factory();
})(this, function () {
  "use strict";
...
(function (factory) {
  ...
  return function () {
      ...
      _createClass(Iti, [{
        ...
        value: function _appendListItems(countries, className) {
          ...
          for (var i = 0; i < countries.length; i++) {
            ...
            tmp += "<li class='iti__country ".concat(className, "' tabIndex='-1' id='iti-item-").concat(c.iso2, "' role='option' data-dial-code='").concat(c.dialCode, "' data-country-code='").concat(c.iso2, "'>"); // add the flag
    ...
    ********************/
    ...
    window.intlTelInputGlobals.version = "16.0.4"; // convenience wrapper
